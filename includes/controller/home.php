<?php
	...
	?>					<dt><?php print '<h4>' . $s->nickname . ' <small>(' . $s->hostname . $s->mountpoint . ')</small></h4>'; ?></dt>
						<dd><?php $s->live ? print "<h5 class=\"text-success\">Online, {$s->listeners} currently listening</h5>"
